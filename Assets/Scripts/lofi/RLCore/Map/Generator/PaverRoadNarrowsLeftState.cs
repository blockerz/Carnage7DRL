...
{
    public class PaverRoadNarrowsLeftState : PaverState
    {
        private int minRoadWidth;
        private float narrowRatio;

        public PaverRoadNarrowsLeftState(Paver paver, int minHeight, int maxHeight, float probablity) : base(paver, minHeight, maxHeight, probablity)
        {
